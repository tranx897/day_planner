...
ActiveRecord::Schema[7.0].define(version: 2024_05_23_225241) do
  ...
  create_table "feelings_level_1s", force: :cascade do |t|
    t.string "name"
  ...
  create_table "feelings_level_2s", force: :cascade do |t|
    t.string "name"
    t.string "description"
  ...
  create_table "feelings_level_3s", force: :cascade do |t|
    t.string "name"
    t.string "description"
